...
enum TokenType {
  ...
  /* The 4 kings of constants (literals) */
  T_BoolConstant, T_StringConstant, T_IntConstant,
  T_DoubleConstant,
  /* 2 Identifiers */
  T_Identifier, T_TypeIdentifier,
  /* The 24 other tokens 
     + - * / % < <= > >= = == != && || ! ; , . [ ] ( ) { } */
  T_Plus, T_Minus, T_Times, T_Divide, T_Mod, T_Less, T_LessEqual,
  T_Greater, T_GreaterEqual, T_Assign, T_Equal, T_NotEqual,
  T_And, T_Or, T_Not, T_Semicolon, T_Comma, T_Dot, T_LBracket,
  T_RBracket, T_LParen, T_RParen, T_LBrace, T_RBrace
};
...
static const char *TokenNames[] = {
  ...
  "T_BoolConstant", "T_StringConstant", "T_IntConstant", "T_DoubleConstant",
  /* 2 Identifies */
  "T_Identifier", "T_TypeIdentifier",
  /* The 24 other tokens 
     + - * / % < > = <= >= == != && || ! ; , . [ ] ( ) { } */
